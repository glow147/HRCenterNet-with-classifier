...
class ResnetCustom(torch.nn.Module):
    def __init__(self, device, weight_fn):
        super().__init__()
        self.device = device
        ...
        for id_ in self.id2charDict:
            print(id_, self.id2charDict[id_])
...
if __name__ == "__main__":
    net = ResnetCustom(device=torch.device('cuda:0'),weight_fn="../resnet_v2021.pt")
